...
function setUsageAlert() {
  ...
  const warningMessage = "⚠️ WARNING: Setting a usage alert will notify you when your daily consumption exceeds the specified threshold. This helps you manage your electricity usage and avoid unexpected high bills.";
  ...
  if (threshold && !isNaN(threshold) && parseFloat(threshold) > 0) {
    ...
    set(alertsRef, {
      ...
      alert(`Usage alert set for ${threshold} kWh. You'll be notified when your daily consumption exceeds this limit.`);
